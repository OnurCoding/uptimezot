...
client.user.setActivity(`+yardım `, { type: "PLAYING" });
  console.log("bot hazırlanıyor babba bekle");
});
...
client.on('message', async message => {
  ...
  fetch(Link).then(() => {
    ...
    **Link Sistemde Zaten Bulunuyor. <a:no_entry:829687812714266634>** 
    ...
    ** Yazdığınız Site Başarıyla Uptime Sistemimize Eklendi. <a:gift:829312643235840020>**
    `)
...
** FreeCity Uptime  Şuanda  \`${db.get('Proje')}\` URL'yi Sorunsuz Bir Şekilde 7/24 Aktif Tutuyor. <a:military_medal:829312643235840020>**

**  FreeCity Uptime  Bu Linklerden Sadece \`${db.fetch(`Sahiplik_${message.author.id}`) || null}\` Tane Senin URl'ni Uptime ediyor!📣 **
`)
...
`)
  .addField('** FreeCity Uptime  - Komutları**',`
» <a:nazar_amulet:829687812714266634> **+ekle (Glitch Show Linki)** = Botunuzu 7/24 Aktif Tutar.
» <a:nazar_amulet:829687812714266634>**+linkler** = 7/24 Tuttuğum linkleri gösterir.
» <a:nazar_amulet:829687812714266634> **+say** = Tüm Uptime edilmiş bot sayısını gösterir.
`)
  .addField('**FreeCity Uptime Bot - Hakkında**',`
» **Prefixim** = **${prefix}**
» <a:sparkles:829682142748475413> [Destek Sunucu] **discord.gg/freecity**
» <a:sparkles:829682142748475413> Yapımcım = <@787940346294042686>
» <a:sparkles:829682142748475413>**NOT: Botu İster Sunucusunda İster Özelden Kullanabilirsiniz Tercih Sizin**`)
